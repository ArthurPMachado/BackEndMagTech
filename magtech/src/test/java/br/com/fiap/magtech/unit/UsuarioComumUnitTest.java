...
class UsuarioComumUnitTest {
	...
	void populateDataForTest() {
		...
		UsuarioComum usuarioComum0 = repositoryUsuario.save(new UsuarioComum("Braufagélio", "01/01/2000", "foto.com", "SP", 924246969,
	...
	void createShouldBeSuccessful() {
		...
		UsuarioComum usuarioComum1 = repositoryUsuario.save(new UsuarioComum("Braufagélio", "01/01/2000", "foto.com", "SP", 924246969,
